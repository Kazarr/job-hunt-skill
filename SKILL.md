---
name: job-hunt
description: Help a job-seeker — analyzing postings, drafting cover letters, researching companies, prepping interviews, handling recruiter communication, negotiating rates and offers, tackling take-home challenges, spotting red flags, and improving a weak CV. Use whenever the user shares a job posting (URL, PDF, or text), pastes a recruiter or hiring-manager email, mentions applying or interviewing at a specific company, asks "should I apply", asks about salary or rate negotiation, asks "is this posting legit", wants help with a take-home, asks to review their CV, or says things like "prep me for this interview", "the recruiter said X what do I reply", "my CV needs work", "they came back with X". Activate even without "job hunt" — a pasted JD, recruiter email, take-home prompt, or comp question tied to an active opportunity is enough. Do NOT activate for hiring/recruiting from the company side, raises at the user's current job, LinkedIn profile optimization, or career-direction questions without an opportunity.
---
