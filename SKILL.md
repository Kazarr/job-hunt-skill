---
name: job-hunt
description: Help a user run a job hunt end-to-end — analyzing postings, drafting cover letters, researching companies, prepping interviews, handling recruiter communication, negotiating rates, tackling take-home challenges, spotting red flags, and improving a weak CV. Use whenever the user shares a job posting (URL, PDF, or pasted text), mentions applying for a role, asks for a cover letter, asks "should I apply", asks for interview prep, pastes a recruiter email, asks about compensation or rate negotiation, asks "is this posting legit", asks for help with a take-home, asks to review or improve their CV, or says things like "help me with my application", "draft a cover letter", "prep me for this interview", "research this company", "is this a fit", "the recruiter said X, what do I reply", "my CV needs work". The skill should activate even when the user does not explicitly say "job hunt" — a pasted job description, recruiter email, or compensation question is enough.
---
